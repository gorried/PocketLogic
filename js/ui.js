...
function renderCalc(calc){
	...
	$.each(fields, function(index, value){
		...
		if(value.type == "slider"){
		...
		} else if(value.type == "boolg"){
			out += '<div class="midbar2"><select class="field bool" name="' + value.varName + '" id="' + value.varName + '" data-role="slider"><option value="' + value.f + '">Male</option><option value="' + value.t + '">Female</option></select></div><div id="separator"></div></div>';
			...
			out += '<div class="midbar2"><select class="field bool" name="' + value.varName + '" id="' + value.varName + '" data-role="slider"><option value="' + value.f + '">No</option><option value="' + value.t + '">Yes</option></select></div><div id="separator"></div></div>';
		}
